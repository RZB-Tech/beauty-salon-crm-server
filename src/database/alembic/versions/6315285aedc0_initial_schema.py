...
Revision ID: 6315285aedc0
Revises: 
Create Date: 2026-09-13 20:57:58.322103
...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_tenants_created_by_actor_id', 'tenants', 'actors', ['created_by_actor_id'], ['id'], ondelete='SET NULL')
    ...
    sa.Column('discount_value', sa.Numeric(precision=30, scale=2), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_constraint('fk_tenants_created_by_actor_id', 'tenants', type_='foreignkey')
